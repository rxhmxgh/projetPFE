...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $reference = $_POST['reference_facture'];
    ...
    try {
        ...
        if ($user && $user['solde'] >= $montant) {
            ...
            $stmt->execute([$_SESSION['user_id'], "Facture ADE", $reference, $montant]);

            $success = "Paiement ADE réussi pour la facture $reference - $montant DA.";
        } else {
...
<head>
    <meta charset="UTF-8">
    <title>Résultat Paiement ADE</title>
    <style>
